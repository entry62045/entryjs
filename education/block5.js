const LibraryCreator = {
    start: (blocksJSON, category, text) => {
      ...
      if (typeof useWebGL == "undefined") {
        ...
        // 아이콘 적용, background-image:url() 부분을 svg 이미지로 변경(첫 번째는 기본, 두 번째는 선택되었을 때), 선택되었을 때 카테고리 버튼 배경색깔 변경 가능
...
//////////////////////////////////////
    {
        ...
        func: async (sprite, script) => { // 코드
            let pagetitle = document.title; // 반환할 변수 지정
            return pagetitle; //반환
        },
    },
//////////////////////////////////////
...
//////////////////////////////////////    
	{
		...
		func: async (sprite, script) => {
			...
			(typeof blockeddone == true) ? true : false
		},
	}
//////////////////////////////////////
]
  
LibraryCreator.start(blocks, 'API', '특급') // '특급' 부분은 다른 이름으로 변경 가능
// 로딩 후 코드 작성